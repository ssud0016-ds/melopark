    ...
    >
      ...
      <View style={{ flex: 1, minWidth: 0 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
          <Text
            style={{ fontSize: 12, fontWeight: '600', color: colors.surfaceDark, flexShrink: 1 }}
            numberOfLines={1}
          >
            {main}
          </Text>
        ...
        {cross ? (
          <Text style={{ fontSize: 11, color: colors.surfaceDarkTertiary, marginTop: 2 }} numberOfLines={1}>
            {cross}
          </Text>
        ) : null}
        <View
        ...
        >
          <Text style={{ fontSize: 11, fontWeight: '500', color: colors.surfaceDarkTertiary, flex: 1 }} numberOfLines={1}>
            {meta}
          </Text>
          {distance ? (
            <Text style={{ fontSize: 11, fontWeight: '500', color: colors.surfaceDarkTertiary, flexShrink: 0 }}>
              {distance}
            </Text>
          ) : null}
        </View>
